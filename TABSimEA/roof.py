...
normalputzmoertel = Solid(name='Normalputzmörtel',
                          density=1300,
                          specific_heat_capacity=1000,
                          heat_conductivity=0.49)

layer0 = Layer(name='layer0_plaster', material=normalputzmoertel, thickness=10)
layer1 = Layer(name='layer1_concrete', material=stahlbeton, thickness=200)
layer2 = Layer(name='layer2_rockwool', material=xps, thickness=289.5)
